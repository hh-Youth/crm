...
import com.pnode.crm.workbench.dao.*;
...
//        }
        ...
        //删除线索
        int count3 = clueDao.deleteList(ids);
...
//        System.out.println("--------"+a.toString());
    ...
    public PaginationVO<Contacts> contactspageList(Map<String, Object> map) {
        ...
        //取得total
        int total = clueDao.getContactsTotalByCondition(map);

        //取得dataList
        List<Contacts> dataList = clueDao.getContactsListByCondition(map);
    ...
    public boolean contactsave(Contacts c) {
        ...
        if (cus!=null){
            ...
            //保存联系人信息
            int count = clueDao.contactsave(c);
