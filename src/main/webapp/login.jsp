...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	...
	<script>
		...
		$(function () {
			...
			//var va=$("#xz:checked").val()

			//为登录页面设置事件
			$("#submitBtn").click(function () {
				var va = $("input[name=xz]:checked");
				login($(va[0]).val());
			...
			<form action="workbench/index.jsp" class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					...
					<div style="position: relative;top: 30px; left: 10px;">
						<input type="checkbox" name="xz" value="yes" >管理员身份
					</div>


					<button type="button" id="submitBtn" class="btn btn-primary btn-lg "  style="width: 350px; position: relative;top: 45px;">登录</button>
