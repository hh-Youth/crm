...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#setBtn").click(function () {
			if ("${sessionScope.user.admit}"=="yes"){
				window.location.href='settings/qx/index.jsp';
			}else {
				alert("普通用户无权限进入!")
			}
		...
		$("#updatePwd").click(function () {
			...
			window.location.href='workbench/user/updatePwd.do?userId=${user.id}&oldPwd='+$.trim($("#oldPwd").val())+'&newPwd='+$.trim($("#newPwd").val())+'&admit=${user.admit}'+'&confirmPwd='+$.trim($("#confirmPwd").val())+'';
	...
	<%--		url : "workbench/user/updatePwd.do",--%>
	<%--		data : {--%>
	<%--			"userId" : ${user.id},--%>
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						允许访问IP：<b>${user.allowIps}</b><br><br>
						是否为管理员：<b>${user.admit}</b>
					</div>
				</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;客户管理</span></div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="javascript:void(0)" id="setBtn"><span class="glyphicon glyphicon-wrench"></span> 权限设置</a></li>
						<li><a href="" data-toggle="modal" data-target="#myInformation"><span class="glyphicon glyphicon-file"></span> 我的资料</a></li>
