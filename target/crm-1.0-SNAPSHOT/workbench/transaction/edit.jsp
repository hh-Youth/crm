...
<head>
	...
	<script>
		...
		$(function () {
			...
			//为"放大镜"图标，绑定事件，打开搜索联系人的模态窗口
			$("#openContactsSearchModalBtn").click(function () {
			...
			$("#create-describe").val("${t1.description}");
			$("#create-contactSummary").val("${t1.contactSummary}");
...
<form action="workbench/transaction/update.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control" value="${t1.money}" id="create-amountOfMoney" name="money">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control" value="${t1.name}" id="create-transactionName" name="name">
		</div>
		<label for="create-expectedClosingDate" class="col-sm-2 control-label">预计成交日期<span style="font-size: 15px; color: red;">*</span></label>
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control time1" value="${t1.expectedDate}" id="create-expectedClosingDate" id="create-expectedClosingDate" name="expectedDate">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control" value="${t1.customerId}" id="create-customerName" name="customerName" placeholder="支持自动补全，输入客户不存在则新建">
		</div>
	...
	<div class="form-group">
		<label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);" id="openContactsSearchModalBtn"><span class="glyphicon glyphicon-search"></span></a></label>
		<div class="col-sm-10" style="width: 300px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control time2" value="${t1.nextContactTime}" id="create-nextContactTime" name="nextContactTime">
		</div>
	</div>
